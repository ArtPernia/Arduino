# 1 "main.c"
# 1 "D:\\CodeliteWorkspace\\des//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "main.c"
# 1 "C:/TDM-GCC-64/lib/gcc/x86_64-w64-mingw32/5.1.0/include/stdbool.h" 1 3 4
# 2 "main.c" 2
...
# 427 "C:/TDM-GCC-64/lib/gcc/x86_64-w64-mingw32/5.1.0/include/stddef.h" 3 4
typedef struct {
...
# 147 "C:/TDM-GCC-64/x86_64-w64-mingw32/include/stdlib.h" 3
...
# 1 "C:/TDM-GCC-64/x86_64-w64-mingw32/include/getopt.h" 1 3
# 22 "C:/TDM-GCC-64/x86_64-w64-mingw32/include/getopt.h" 3
extern int optind;
extern int optopt;
extern int opterr;
...
# 62 "C:/TDM-GCC-64/x86_64-w64-mingw32/include/getopt.h" 3
struct option
{
  const char *name;
  int has_arg;
...
void Permutation(uint64_t* data, 
# 28 "DES.h" 3 4
                                _Bool 
# 28 "DES.h"
                                     initial);
...
_Bool 
# 31 "DES.h"
    key_parity_verify(uint64_t key);
# 42 "DES.h"
...
# 25 "main.c" 3
               (&__iob_func()[1])
# 25 "main.c"
                     ,"Usage: desbox [OPTION] -k=KEY FILE\n"
...
# 35 "main.c" 3
               (&__iob_func()[2])
# 35 "main.c"
                     , "Try 'desbox --help' for more information.\n");
    }
    exit(status);
}
...
# 63 "main.c"
    ...
    while((optc = getopt_long(argc, argv, short_opts, long_opts, 
# 66 "main.c" 3 4
                                                                ((void *)0)
# 66 "main.c"
                                                                    )) != -1)
...
# 121 "main.c" 3
               (&__iob_func()[2])
# 121 "main.c"
                     , "Error: You are supposed to pass a key as argument\n");
        usage(
# 122 "main.c" 3
             1
# 122 "main.c"
